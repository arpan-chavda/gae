...
class Hindu2(BaseFeedBook):
    ...
    remove_tags = ['script',]
    remove_ids = ['google-ad-border','pc1','addshare',]
    remove_classes = ['dateline','artbcrumb','artPubUpdate','related-column','article-links', #qiushibaike
            'article-Keywords','rel-block-news','rel-block-sec',] # haha.mx
